!function () {
    ...
    "use strict";
    function e(e, t, n, a, i, l, o, s, r) {
        function d() {
            "icon" === s.layout.sideMenuSize && (l.find(".triangular-sidenav-left").addClass("hover"), n(function () {
                o.dispatchEvent(new Event("resize"))
            }, 300))
        }

        function m(t) {
            var o = l.find(".triangular-content");
            "@triangular" === t && angular.isDefined(s.layout.footerTemplateUrl) && a(s.layout.footerTemplateUrl).then(function (t) {
                var a = i(t), l = a(e);
                n(function () {
                    o.append(l)
                })
        ...
        function p() {
            "icon" === s.layout.sideMenuSize && (l.find(".triangular-sidenav-left").removeClass("hover"), n(function () {
                o.dispatchEvent(new Event("resize"))
            }, 300))
        }
        ...
        function h(e, t) {
            angular.isDefined(s.layout.footer) && s.layout.footer === !0 && m(t);
            var n = b.indexOf(t);
            -1 !== n && b.splice(n, 1), 0 === b.length && r.setLoaderActive(!1)
        }

        var b = [], v = this;
        v.activateHover = d, v.removeHover = p, v.showLoader = r.isActive(), e.layout = s.layout, e.$on("loader", c), e.$on("$stateChangeStart", u), e.$on("$viewContentLoading", g), e.$on("$viewContentLoaded", h)
    }
    ...
    function e(e, t, n, a, i, l, o, s, r) {
        ...
        function c() {
            return "hidden" !== s.layout.sideMenuSize && t("gt-sm")
        }
        ...
        var p = this;
        p.breadcrumbs = o.breadcrumbs, p.filterEmailList = d, p.hideMenuButton = c, p.openSideNav = u, p.showSearch = !1, p.toggleSearch = m, p.toolbarMenu = [];
        for (var g = 0; g < r.length; g++)p.toolbarMenu.push({
            name: n("triTranslate")(r[g].name),
            state: r[g].state,
            icon: r[g].icon
        })
    }
    ...
    "use strict";
    function e(e, t, n, a, i, l, o) {
        function s(e) {
            o.calendars["triangular-calendar"].fullCalendar(e)
        }

        function r(e) {
            m.currentView = e, o.calendars["triangular-calendar"].fullCalendar("changeView", e.viewName)
        }
        ...
        var m = this;
        m.breadcrumbs = l.breadcrumbs, m.changeMonth = s, m.changeView = r, m.openSideNav = d, m.views = [{
            name: "Month",
    ...
    function e(e, t, n, a, i) {
        function l() {
            "icon" === i.layout.sideMenuSize && (t.find(".admin-sidebar-left").addClass("hover"), n(function () {
                a.dispatchEvent(new Event("resize"))
            }, 300))
        }

        function o() {
            "icon" === i.layout.sideMenuSize && (t.find(".admin-sidebar-left").removeClass("hover"), n(function () {
                a.dispatchEvent(new Event("resize"))
            }, 300))
        }
        ...
        e.layout = i.layout;
        var s = this;
        s.activateHover = l, s.removeHover = o
    }
    ...
    function e(e, t, n, a) {
        function i(e, i) {
            ...
            function o() {
                var l = i.find("#admin-panel-content-view"), o = l.find("#footer");
                0 === o.length && n(a.layout.footerTemplateUrl).then(function (n) {
                    var a = t(n), i = a(e);
                    l.append(i)
                })
            }

            e.$on("$stateChangeStart", l), e.$on("$viewContentLoaded", o)
        }

        var l = {link: i, replace: !0, restrict: "A"};
        return l
    }
    ...
    function t(e, t) {
        ...
        c.currentStep = 0, c.getForm = n, c.isFormValid = l, c.nextStep = a, c.nextStepDisabled = i, c.prevStep = o, c.prevStepDisabled = s, c.progress = 0, c.registerForm = r, c.updateProgress = d, t(function () {
            p = m()
        })
    }
    ...
    function e() {
        function e(e, t, n, a) {
            var i = a[0], l = a[1];
            l.registerForm(i), t.on("input", function () {
                l.updateProgress()
            })
        }
    ...
    function e(e) {
        function t(t, n, a) {
            ...
            t.pageSize = angular.isUndefined(a.pageSize) ? 0 : a.pageSize, t.page = angular.isUndefined(a.page) ? 0 : a.page, angular.forEach(t.columns, function (e) {
                e.sortable && i.push(e.field)
            }), t.refresh = function (n) {
                n === !0 && (t.page = 0), t.contents = e("orderBy")(t.contents, l, o)
            }, i.length > 0 && (o = !1, l = i[0], t.refresh()), t.sortClick = function (e) {
                i.indexOf(e) !== -1 && (e === l && (o = !o), l = e, t.refresh())
            }, t.showSortOrder = function (e, t) {
                return e === l && o === t
            }, t.headerClass = function (e) {
                var t = [];
                return i.indexOf(e) !== -1 && t.push("sortable"), e === l && t.push("sorted"), t
    ...
    "use strict";
    function e(e, t, n, a, i, l, o, s, r, d, m, c, u, p, g) {
        function h(e) {
            s.debounce(function () {
                r(e).toggle()
            }, 300)()
        ...
        function b(e) {
            if (t.has("$translate")) {
                ...
                a.use(e).then(function () {
                    d.show(d.simple().content(o("triTranslate")("Language Changed")).position("bottom right").hideDelay(500)), n.$emit("changeTitle")
                })
            }
        }
        ...
        var w = this;
        w.breadcrumbs = u.breadcrumbs, w.emailNew = !1, w.languages = p.languages, w.openSideNav = h, w.hideMenuButton = v, w.switchLanguage = b, w.toggleNotificationsTab = f, w.isFullScreen = !1, w.fullScreenIcon = "zmdi zmdi-fullscreen", w.toggleFullScreen = y, e.$on("newMailNotification", function () {
            w.emailNew = !0
        })
    }
    ...
    function e(e, t, n, a, i) {
        function l() {
            a.go("triangular-no-scroll.email.inbox"), s.close()
        }
        ...
        var s = this;
        s.close = o, s.currentTab = 0, s.notificationGroups = [{
            name: "Twitter",
            notifications: [{
            ...
            s.currentTab = t
        }), t({method: "GET", url: i.url + "email/inbox"}).success(function (e) {
            s.emails = e.slice(1, 20)
        })
    }
    ...
    function e() {
        ...
        function a() {
            for (var e = o.length - 1; e >= 0; e--)o.splice(e, 1)
        }
        ...
        function i(e, t) {
            ...
            if (e instanceof Array)for (var a = 0; a < e.length; a++) {
                ...
                if (angular.isDefined(e[a].children) && (n = i(e[a].children, t), angular.isDefined(n)))break
            }
            return n
        }

        function l(e, t, n, a) {
            if (e instanceof Array)for (var i = e.length - 1; i >= 0; i--) {
                if (e[i].state === t && angular.equals(e[i].params, n)) {
                    e.splice(i, 1), isNaN(a) || o[a].children.length || o.splice(a, 1);
                    break
                }
                angular.isDefined(e[i].children) && l(e[i].children, t, n, i)
            }
        }

        var o = [];
        this.addMenu = e, this.removeMenu = n, this.removeAllMenu = a, this.$get = function () {
            return {menu: o, addMenu: e, getMenu: t, removeMenu: n, removeAllMenu: a}
        }
    }
    ...
    function e(e, n, a) {
        function i(e, t) {
            n(t);
            var i = t.controller("mdTheme"), l = a.getThemeHue(i.$mdTheme, "primary", "default"), o = a.rgba(l.value);
            t.css({"background-color": o}), t.children("md-content").css({"background-color": o})
        }
    ...
    function t(e, t, n, a, i, l, o) {
        function s() {
            m.item.active = a.includes(m.item.state, m.item.params), m.item.active && (o.reset(), o.addCrumb(m.item), e.$emit("openParents"))
        }
        ...
        switch (m.item.template = "app/triangular/components/menu/menu-item-" + m.item.type + ".tmpl.html", m.item.type) {
            case"dropdown":
                m.item.children = i("orderBy")(m.item.children, "priority"), m.toggleDropdownMenu = r, e.$on("toggleDropdownMenu", function (e, t, n) {
                    m.item === t ? m.item.open = n : m.item.open = !1
                }), e.$on("openParents", function () {
                    m.item.open = !0, o.addCrumb(m.item)
                });
                break;
            case"link":
                m.openLink = d, s(a.current.name, a.params), e.$on("$stateChangeSuccess", function (e, t, n) {
                    s(t.name, n)
                })
        }
    }
    ...
    function e(e, t, n) {
        function a(n) {
            var a, i = n ? r.states.filter(s(n)) : r.states;
            return self.simulateQuery ? (a = t.defer(), e(function () {
                a.resolve(i)
            }, 1e3 * Math.random(), !1), a.promise) : i
        }
        ...
        var r = this;
        r.states = o(), r.selectedItem = null, r.searchText = null, r.querySearch = a, r.simulateQuery = !1, r.isDisabled = !1, r.selectedItemChange = l, r.searchTextChange = i
    }
    ...
    function e(e) {
        function t(t, n, a, i) {
            i.setLoading(!0);
            var l = 'select item.condition from weather.forecast where woeid in (select woeid from geo.places(1) where text="' + a.weatherWidget + '")', o = "https://query.yahooapis.com/v1/public/yql?q=" + encodeURIComponent(l) + "&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys";
            e.get(o).success(function (e) {
                e.query.count > 0 && (i.setLoading(!1), t.weather = {
    ...
    function e(e, t) {
        function n(e) {
            function n(e) {
                for (e.data[0].length && (e.labels = e.labels.slice(1), e.data[0] = e.data[0].slice(1)); e.data[0].length < e.dataLength;)e.labels.push(""), e.data[0].push(i(e.data[0], e.maximum))
            }
            ...
            function i(e, t) {
                var n = e.length, a = n ? e[n - 1] : 50, i = a + 10 * Math.random() - 5;
    ...
    function e(e, t, n) {
        function a(a, i, l, o) {
            ...
            r.$inject = ["$scope", "$mdDialog", "data"], o.setLoading(!0);
            var d = e(l.loadDataWidget)(a);
            o.setMenu({
                ...
                t.get(e).success(function (e) {
                    var t = e.shift();
                    o.setLoading(!1), a[n] = {header: t, data: e}
                })
            })
        }

        var i = {require: "triWidget", link: a, restrict: "A"};
        return i
    }
    ...
    function e(e, t) {
        function n(e) {
            function n() {
                for (e.tickerChart.data[0].length && (e.tickerChart.labels = e.tickerChart.labels.slice(1), e.tickerChart.data[0] = e.tickerChart.data[0].slice(1)); e.tickerChart.data[0].length < i;)e.tickerChart.labels.push(""), e.tickerChart.data[0].push(a(e.tickerChart.data[0]))
            }
    ...
    function e(e, t) {
        function n(n, a, i, l) {
            ...
            l.setLoading(!0), e(function () {
                l.setLoading(!1), o()
            }, 1500), l.setMenu({
                icon: "zmdi zmdi-more-vert",
                items: [{
                    icon: "zmdi zmdi-refresh", title: "Refresh", click: function () {
                        t.cancel(n.intervalPromise), l.setLoading(!0), e(function () {
                            l.setLoading(!1), o()
                        }, 1500)
                    }
                }, {icon: "zmdi zmdi-share", title: "Share"}, {icon: "zmdi zmdi-print", title: "Print"}]
    ...
    function t(e, t, n) {
        ...
        var o = this;
        o.calendarEvents = [], o.calendarOptions = {
            lang: "en", header: !1, height: "auto", viewRender: function (e) {
                o.currentDay = e.calendar.getDate()
            }
        }, o.changeMonth = a;
        var s = n.$on("$translateChangeSuccess", i);
        e.$on("$destroy", l)
    }
    ...
    function e() {
        ...
        function n(e) {
            for (var t = ["complete", "pending", "delivered"], n = ["Loraine Heidenreich", "Amie Hane", "Rosalyn Heller V", "Dr. Kristian Boyle II", "Clarabelle Weber", "Rowland Emard", "Kitty Heller DVM", "Winston Frami", "Newton Welch", "Trudie Feest", "Vivien Sauer", "Cleta Kuhn", "Ruby Shields", "Dr. Moises Beahan DDS", "Miss Shanel Jenkins DVM", "Kitty Heller DVM", "Vivien Sauer", "Clara Cremin", "Eunice Morissette", "Arch Sporer IV", "Miss Shanel Jenkins DVM", "Ryann Balistreri I", "Norma Yost DDS", "Manley Roberts", "Ruby Shields", "Miss Lavada Runolfsson", "Kira Dooley", "Meredith Ebert DDS"], a = ["johnson.althea@gleichner.net", "will.rhea@weber.biz", "roslyn75@keebler.com", "okon.glenda@hamill.com", "estroman@cruickshank.org", "victoria41@hartmann.com", "bogisich.janice@wilkinson.com", "bryce97@kris.com", "noe59@king.com", "wiza.litzy@kozey.com", "oconner.cortney@gmail.com", "kub.fannie@hotmail.com", "adrian00@gutkowski.com", "justice69@yahoo.com", "torphy.toney@yahoo.com", "bogisich.janice@wilkinson.com", "oconner.cortney@gmail.com", "orval63@gmail.com", "jaime94@gmail.com", "olaf69@okeefe.com", "torphy.toney@yahoo.com", "bernhard.bruen@marvin.com", "otilia61@hotmail.com", "bogan.lelia@bins.info", "adrian00@gutkowski.com", "yazmin76@hotmail.com", "kglover@hotmail.com", "erick.hermann@larkin.net", "bernhard.bruen@marvin.com", "bradly90@corkery.info", "orval63@gmail.com", "olaf69@okeefe.com"], i = {
                ...
                tax: 0,
                total: 0
            }, l = Math.floor(5 * Math.random()) + 1, s = ["Super", "Amazing", "Great", "New"], r = ["T-Shirt", "Book", "Desk", "Coat", "Chair", "Hat", "Jeans"], d = ["Red", "Green", "Blue", "Pink", "Yellow", "Orange"], m = ["Books", "Electronics", "Home", "Toys", "Clothes", "Shoes", "Mobiles"], c = 0; c < l; c++) {
                var u = {
                    name: s[Math.floor(Math.random() * s.length)] + " " + d[Math.floor(Math.random() * d.length)] + " " + r[Math.floor(Math.random() * r.length)],
                    category: m[Math.floor(Math.random() * m.length)],
                    price: (99 * Math.random() + 1).toFixed(2)
                };
                i.subTotal += parseFloat(u.price), i.items.push(u)
            }
            return i.tax = .2 * i.subTotal, i.total += i.subTotal + i.tax, i
        }
        ...
        function l(e) {
            ...
            }, n = [], a = 0; a < e.orders.length; a++)for (var i = 0; i < e.orders[a].items.length; i++) {
                t.labels.indexOf(e.orders[a].items[i].category) === -1 && (t.labels.push(e.orders[a].items[i].category), n.push(0));
                var l = t.labels.indexOf(e.orders[a].items[i].category);
                n[l]++
            }
            return t.data.push(n), t
        }
        ...
        return {generateSales: e, createLineChartData: a, createPieChartData: i, createBarChartData: l}
    }
    ...
    function e(e, t, n) {
        ...
        var o = this;
        o.cancelClick = i, o.okClick = a, o.order = n, o.printClick = l
    }
    ...
    function e(e, t) {
        function n() {
            t.start = new moment(i.start), t.end = new moment(i.end), e.hide()
        }
        ...
        var i = this;
        i.cancelClick = a, i.okClick = n, i.start = t.start.toDate(), i.end = t.end.toDate()
    }
    ...
    function e(e, t, n, a, i, l, o) {
        ...
        function r() {
            d.salesData = o.generateSales(d.dateRange), d.chartLineData = o.createLineChartData(d.salesData), d.chartPieData = o.createPieChartData(d.salesData), d.chartBarData = o.createBarChartData(d.salesData)
        }
        ...
        d.dateRange = {start: moment().startOf("week"), end: moment().endOf("week")}, d.query = {
            ...
            limit: 5,
            page: 1
        }, d.openOrder = s, e.$on("salesChangeDate", function (e, t) {
            l.show({
                ...
                r(), a.show(a.simple().content(i("triTranslate")("Date Range Updated")).position("bottom right").hideDelay(2e3))
            })
        }), r()
    }
        ...
        function l() {
            t(function () {
                ...
                n.show(e).then(function (e) {
                    "ok" == e && i.go("triangular.email.inbox")
                })
            }, 5e3)
        }
    ...
    function e(e, t) {
        function n(t) {
            null !== t && t.length > 0 && (s = t, a(), e(i, 4e3))
        }
    ...
    function e(e, t, n, a) {
        function i() {
            ...
            e.$watch("vm.query.filter", function (e, n) {
                n || (t = s.query.page), e !== n && (s.query.page = 1), e || (s.query.page = t), s.getUsers()
            })
        }

        function l() {
            s.promise = a.getUsers(s.query), s.promise.then(function (e) {
                s.users = e.data
            })
        }

        function o() {
            s.filter.show = !1, s.query.filter = "", s.filter.form.$dirty && s.filter.form.$setPristine()
        }

        var s = this;
        s.query = {filter: "", limit: "10", order: "-id", page: 1}, s.selected = [], s.columns = {
            avatar: "Avatar",
            login: "Login",
            id: "ID"
        }, s.filter = {options: {debounce: 500}}, s.getUsers = l, s.removeFilter = o, i()
    }
    ...
    function e(e) {
        function t(t) {
            var n, a = 0;
            for (var i in e.palettes)Math.random() < 1 / ++a && "white" !== i && (t.palette = i, n = e.palettes[i]);
    ...
    function e(e, t, n) {
        ...
        var i = this;
        i.fabDirections = ["up", "down", "left", "right"], i.fabDirection = i.fabDirections[0], i.fabAnimations = ["md-fling", "md-scale"], i.fabAnimation = i.fabAnimations[0], i.fabStatuses = [!1, !0], i.fabStatus = i.fabStatuses[0], i.share = a
    }
    ...
    function e(e) {
        function t() {
            for (i.data[0].length && (i.labels = i.labels.slice(1), i.data[0] = i.data[0].slice(1)); i.data[0].length < a;)i.labels.push(""), i.data[0].push(n(i.data[0]))
        }
    ...
    function e(e, t, n, a, i, l) {
        function o() {
            n.show(n.simple().content(i("triTranslate")("Confirmation sent")).position("bottom right").action(i("triTranslate")("Login")).highlightAction(!0).hideDelay(0)).then(function () {
                t.go("authentication.login")
            })
        }

        var s = this;
        s.triSettings = l, s.signupClick = o, s.user = {name: "", email: "", password: "", confirm: ""}
    }
    ...
    function e(e, t, n, a, i, l) {
        ...
        var s = this;
        s.triSettings = l, s.user = {email: ""}, s.resetClick = o
    }
                ...
                return {
                    getTheme: function (e) {
                        ...
                        if (angular.isDefined(e._THEMES[t]) && angular.isDefined(e._THEMES[t].colors[n])) {
                            var i = e._THEMES[t].colors[n];
                            if (angular.isDefined(e._PALETTES[i.name]) && angular.isDefined(e._PALETTES[i.name][i.hues[a]]))return e._PALETTES[i.name][i.hues[a]]
                        }
    ...
    function e(e, n) {
        ...
        return {
            skin: function (i, l) {
                if (angular.isDefined(a[i]))return a[i];
                var o = new t(i, l, e, n);
                return a[i] = o, a[i]
            }, setSkin: function (e) {
                if (!angular.isUndefined(a[e])) {
                    if (i = a[e], l) {
                        ...
                        if (angular.isDefined(n)) {
                            ...
                            i = angular.isDefined(a[o.skin]) ? a[o.skin] : a[0]
                        }
                    }
                    return i.loadThemes(), i
                }
    ...
    function t(e, t, n, a) {
        var i = ["sidebar", "logo", "toolbar", "content"], l = this;
        l.id = e, l.name = t, l.elements = {}, i.forEach(function (e) {
            l[e + "Theme"] = function (t) {
                return l.elements[e] = t, l
            }
        }), l.loadThemes = function () {
            for (var e in l.elements) {
                var t = a.theme(l.elements[e]);
            ...
            n.setDefaultTheme(l.elements.content)
        }
    }
    ...
    "use strict";
    function e(e, t, n, a, i, l, o, s) {
        function r() {
            i(function () {
                var e = o.title;
                angular.forEach(d.crumbs, function (t) {
                    var n = t.name;
                    l.has("translateFilter") && (n = a("translate")(t.name)), e += " " + o.separator + " " + n
                }), t.document.title = e
            })
        }

        var d = s.breadcrumbs, m = e.$on("changeTitle", function () {
            r()
        });
    ...
    function e(e, t) {
        function n(n, a, i) {
            e(a);
            var l = a.controller("mdTheme");
            if (angular.isDefined(l)) {
                var o = i.themeBackground, s = "default";
                if (o.indexOf(":") !== -1) {
                    var r = i.themeBackground.split(":");
                    o = r[0], s = r[1]
                }
                var d = t.getThemeHue(l.$mdTheme, o, s);
    ...
    function e(e) {
        function t(t, n, a) {
            var i = a.paletteBackground.split(":"), l = e.getPaletteColor(i[0], i[1]);
            angular.isDefined(l) && n.css({
                "background-color": e.rgba(l.value),
                "border-color": e.rgba(l.value),
                color: e.rgba(l.contrast)
            })
        }
    ...
    function e(e) {
        function t(t, n, a) {
            var i, l = {useEasing: !0, useGrouping: !0, separator: ",", decimal: ".", prefix: "", suffix: ""};
            if (t.options)for (var o in l)angular.isDefined(t.options[o]) && (l[o] = t.options[o]);
            a.from = angular.isUndefined(a.from) ? 0 : parseInt(a.from), a.decimals = angular.isUndefined(a.decimals) ? 2 : parseFloat(a.decimals), a.duration = angular.isUndefined(a.duration) ? 5 : parseFloat(a.duration), e(function () {
                i = new CountUp(n[0], a.from, t.countupto, a.decimals, a.duration, l), i.start(), t.$watch("countupto", function (e, t) {
                    angular.isDefined(e) && e != t && i.update(e)
                })
            }, 500)
        }
    ...
    function e() {
        ...
        }, a = ["toolbarSize", "toolbarShrink", "toolbarClass", "contentClass", "innerContentClass", "sideMenuSize", "showToolbar", "footer", "contentTemplateUrl", "sidebarLeftTemplateUrl", "sidebarLeftController", "sidebarRightTemplateUrl", "sidebarRightController", "toolbarTemplateUrl", "toolbarController", "footerTemplateUrl", "loaderTemplateUrl", "loaderController"], i = {};
        this.getDefaultOption = e, this.setDefaultOption = t, angular.extend(i, n), this.$get = function () {
            function e(e, t) {
                i[e] = t
            }
            ...
            function t(e, t) {
                ...
                var l = angular.isDefined(t.data) && angular.isDefined(t.data.layout) ? t.data.layout : {};
                angular.extend(i, i, l)
            }

            return {layout: i, setOption: e, updateLayoutFromState: t}
        }
    }
    ...
    function e(e, t, n, a, i, l, o) {
        function s() {
            ...
            angular.forEach(o.data, function (t) {
        ...
        var m = this;
        m.userList = o.data, m.roleList = [], m.permissionList = [], m.allRoles = a.getStore(), m.allPermissions = i.getStore(), m.loginClick = r, m.selectUser = d, s()
    }
    ...
    function e(e, t, n, a, i, l, o, s, r, d, m, c, u, p, g) {
        ...
        var w = this;
        if (w.breadcrumbs = u.breadcrumbs, w.emailNew = !1, w.languages = p.languages, w.openSideNav = h, w.hideMenuButton = v, w.switchLanguage = b, w.toggleNotificationsTab = f, w.isFullScreen = !1, w.fullScreenIcon = "zmdi zmdi-fullscreen", w.toggleFullScreen = y, t.has("UserService")) {
    ...
    e.$inject = ["$scope", "$http", "$mdSidenav", "$state", "API_CONFIG"], angular.module("triangular.components").controller("RightSidenavController", e)
}(), function () {
    "use strict";
    angular.module("app", ["ui.router", "triangular", "ngAnimate", "ngCookies", "ngSanitize", "ngMessages", "ngMaterial", "googlechart", "chart.js", "linkify", "ui.calendar", "angularMoment", "textAngular", "uiGmapgoogle-maps", "hljs", "md.data.table", angularDragula(angular), "ngFileUpload", "app.translate", "app.permission", "app.examples"]).constant("API_CONFIG", {url: "http://triangular-api.oxygenna.com/"})
}(), function () {
    "use strict";
    function e(e) {
        var t = this;
    ...
    function e(e, t) {
        function n(n, a, i) {
            ...
            t.WebFont.load({google: {families: [i.webfontLoader]}, active: l, inactive: o})
        }
    ...
    function e(e, t, n, a) {
        ...
        return {changeFont: o, getCurrentFont: l, init: i}
    }
    ...
    function e(e, t, n, a) {
        function i() {
            o.selectedSkin !== n.getCurrent() && (e.put("triangular-skin", angular.toJson({skin: o.selectedSkin.id})), t.location.reload())
        }

        function l() {
            for (var e in o.elementColors) {
                var t = a.getTheme(o.selectedSkin.elements[e]), n = angular.isUndefined(t.colors.primary.hues["default"]) ? "500" : t.colors.primary.hues["default"], i = a.getPaletteColor(t.colors.primary.name, n);
                o.elementColors[e] = a.rgba(i.value)
            }
        }
        ...
        o.elementColors = {
            ...
            content: "",
            toolbar: ""
        }, o.skins = n.getSkins(), o.selectedSkin = n.getCurrent(), o.trySkin = i, o.updatePreview = l, l()
    }
    ...
    function e(e, t, n, a, i) {
        ...
        var o = this;
        o.groups = [], o.icons = [], o.iconSource = "Select icon below to see HTML", o.selectIcon = l, o.icons = i.data
    }
    ...
    function e(e, t, n, a, i) {
        function l() {
            var e = [];
            for (var t in i.data)e.push({className: t, name: i.data[t]});
            return e
        }
        ...
        var s = this;
        s.icons = l(), s.iconSource = "Select icon below to see HTML", s.selectIcon = o
    }
    ...
    function e(e, t) {
        ...
        function a(t, n, a) {
            function l() {
                i.alert = "You cancelled the dialog."
            }
            ...
            e.show({
                ...
                i.alert = 'You said the information was "' + e + '".'
            }, l)
        }

        var i = this;
        i.colourRGBA = n, i.palettes = t.palettes, i.selectPalette = a
    }
    ...
    function e(e, t, n, a) {
        ...
        var l = this;
        l.itemStyle = i, l.name = t, l.palette = [];
        for (var o in n)l.palette.push({code: o, palette: n[o]})
    }
    ...
    function e(e) {
        ...
        function a(e) {
            for (var t = o.length - 1; t >= 0; t--)o[t] === e && o.splice(t, 1);
            l()
        }

        function i() {
            for (var e = 0, t = o.length - 1; t >= 0; t--)o[t].selected === !1 && e++;
            return e
        }
        ...
        var o = [{
            ...
            priority: "low",
            selected: !0
        }, {description: "Arrange meeting", priority: "low", selected: !0}], s = e.getMenu("todo"), r = {
            addTodo: t,
            getTodos: n,
            removeTodo: a,
            todoCount: i,
    ...
    function e(e, t, n, a) {
        function i() {
            r.todos = a.getTodos(), a.updateMenuBadge()
        }
        ...
        var r = this;
        r.orderTodos = l, r.removeTodo = o, r.todoSelected = s, i(), e.$on("addTodo", function (e) {
            n.show({
    ...
    function e(e, t) {
        ...
        var i = this;
        i.cancel = a, i.hide = n, i.item = {description: "", priority: "", selected: !1}
    }
    ...
    function e(e, t, n, a, i) {
        function l() {
            r.allPagesCode = "triLayoutProvider.setDefaultOption('toolbarSize', '" + r.layout.toolbarSize + "');\ntriLayoutProvider.setDefaultOption('toolbarShrink', " + r.layout.toolbarShrink + ");\ntriLayoutProvider.setDefaultOption('toolbarClass', '" + r.layout.toolbarClass + "');\ntriLayoutProvider.setDefaultOption('contentClass', '" + r.layout.contentClass + "');\ntriLayoutProvider.setDefaultOption('sideMenuSize', '" + r.layout.sideMenuSize + "');\ntriLayoutProvider.setDefaultOption('footer', " + r.layout.footer + ");\n", r.onePageCode = ".state('triangular.my-state', {\n    // set the url of this page\n    url: '/my-route',\n    // set the html template to show on this page\n    templateUrl: 'app/examples/my-module/my-page.tmpl.html',\n    // set the controller to load for this page\n    controller: 'MyController',\n    controllerAs: 'vm'\n    data: {\n        layout: {\n            toolbarSize: '" + r.layout.toolbarSize + "',\n            toolbarShrink: " + r.layout.toolbarShrink + ",\n            toolbarClass: '" + r.layout.toolbarClass + "',\n            contentClass: '" + r.layout.contentClass + "',\n            sideMenuSize: '" + r.layout.sideMenuSize + "',\n            footer: " + r.layout.footer + "\n        }\n    }\n});"
        }

        function o(t) {
            switch (t) {
                case"footer":
                    var a = r.layout.footer ? "block" : "none";
                    n[0].getElementById("footer").style.display = a;
                    break;
                case"toolbarShrink":
                    var i = angular.element("#admin-panel md-content");
                    e.$broadcast("$mdContentLoaded", angular.element(i[0]))
            }
            l()
        }

        function s() {
            r.options.toolbarBackgrounds.none = "No Background ";
            var e, n;
            for (e = 1; e < 40; e++)n = t("padding")(e, 2), r.options.toolbarBackgrounds["full-image-background mb-bg-" + n] = "Background " + e;
            for (e = 1; e < 30; e++)n = t("padding")(e, 2), r.options.toolbarBackgrounds["full-image-background mb-bg-fb-" + n] = "Extra Background " + e
        }

        var r = this;
        r.allPagesCode = "", r.updateOption = o, r.layout = i.layout, r.onePageCode = "", r.options = {
            toolbarSizes: {
                "default": "Default",
    ...
    function e(e, t, n) {
        function a() {
            function t(e) {
                n.setLoaderActive(!1), angular.isDefined(e.data.error) && o(e.data.error)
            }

            n.setLoaderActive(!0), e.put(s + "/register-github-access", r.data).then(function () {
                n.setLoaderActive(!1), o("Success!  Check your GitHub email for your invite.")
            }, t)
        }
        ...
        function l() {
            r.data.purchaseCode = "", r.data.githubUser = ""
        }
        ...
        var s = "http://api.oxygenna.com", r = this;
        r.data = {id: "11711437", purchaseCode: "", githubUser: ""}, r.register = a, r.userSearch = i, l()
    }

    e.$inject = ["$http", "$mdToast", "triLoaderService"],
        angular.module("app.examples.github").controller("GithubController", e)
}(),function () {
    "use strict";
    function e(e, t) {
    ...
    function e(e) {
        function t(e) {
            var t = Math.floor(10 * Math.random() + 1), n = s[Math.floor(Math.random() * (s.length - 1) + 1)], a = [300, 640], i = [225, 480], l = {
                url: "http://lorempixel.com/",
                urlFull: "http://lorempixel.com/",
                title: e
            };
            return Math.random() < .7 ? (l.url += a[0] + "/" + i[0], l.urlFull += a[1] + "/" + i[1], l.rowspan = 2, l.colspan = 2) : (l.url += i[0] + "/" + a[0], l.urlFull += i[1] + "/" + a[1], l.rowspan = 2, l.colspan = 1), l.url += "/" + n + "/" + t, l.urlFull += "/" + n + "/" + t, l
        }
        ...
        function n(e) {
            for (var n = {
                ...
                images: []
            }, a = Math.floor(4 * Math.random() + 6), i = 0; i < a; i++)n.images.push(t("Photo " + (i + 1)));
            return n
        }
        ...
        function i() {
            for (var e = 0; e < o; e++)l.feed.push(n(e))
        }

        var l = this;
        l.feed = [], l.openImage = a;
        var o = 5, s = ["abstract", "city", "people", "nature", "food", "fashion", "nightlife"];
        i()
    }
    ...
    function e(e, t, n) {
        function a() {
            var e = t.images.indexOf(l.currentImage);
            e = e + 1 < t.images.length ? e + 1 : 0, l.currentImage = t.images[e]
        }

        function i() {
            var e = t.images.indexOf(l.currentImage);
            e = e - 1 < 0 ? t.images.length - 1 : e - 1, l.currentImage = t.images[e]
        }

        var l = this;
        l.currentImage = n, l.next = a, l.prev = i
    }
    ...
    function e(e) {
        function t(t, n) {
            ...
            var i = [], l = [], o = e(function () {
                i = n.find(".timeline-widget"), i.length > 0 && i.toArray().every(a) && (l = n.find(".timeline-x-axis"), s(), e.cancel(o))
            }, 1e3), s = function () {
                for (var e = 0; e < i.length; e++)if (angular.element(i[e]).offset().top <= angular.element(window).scrollTop() + .8 * angular.element(window).height() && angular.element(i[e]).height() > 1) {
                    var t = e % 2 === 0 ? "left" : "right";
                    angular.element(l[e]).addClass("timeline-content-animated " + t), angular.element(i[e]).addClass("timeline-content-animated " + t)
                }
            };
            angular.element("md-content").bind("scroll", s).scroll()
        }
    ...
    "use strict";
    function e(e, t, n, a, i, l, o, s, r, d, m) {
        function c() {
        ...
        function g(e) {
            function n() {
                r.show(r.simple().content(t("triTranslate")("Email canceled")).position("bottom right").hideDelay(3e3))
            }
        ...
        function h(e, n) {
            ...
            angular.forEach(n.to, function (e) {
                a.push(e.name)
            }), r.show(r.simple().content(t("triTranslate")("Email to {{to}} sent.", {to: a.join(", ")})).position("bottom right").hideDelay(3e3))
        }

        function b() {
            v.showEmailList = !(i("xs") && angular.isDefined(a.current.resolve.email))
        }
        ...
        }), e.$on("$locationChangeSuccess", b), e.$on("deleteEmail", function (e, n) {
            angular.forEach(v.emailGroups, function (e) {
                var a = null;
                angular.forEach(e.emails, function (e, t) {
                    n.id === e.id && (a = t)
                }), null !== a && (e.emails.splice(a, 1), r.show(r.simple().content(t("triTranslate")("DeleteD")).position("bottom right").hideDelay(3e3)))
            }), p()
        }), e.$on("closeEmail", p), e.$on("sendEmail", h), b(), c()
    }
    ...
    function e(e, t, n, a, i, l, o, s) {
        ...
        function m(e, t) {
            var n = {
                ...
                cc: [],
                bcc: [],
                subject: "" === o.subject ? "" : i("triTranslate")("R.e: ") + o.subject,
                content: "<br><br><blockquote>" + o.content + "</blockquote>"
            };
            angular.forEach(s.data, function (e) {
                e.email === o.from.email && n.to.push(e)
            }), c(e, n, i("triTranslate")(t))
        }

        function c(t, l, o) {
            function r() {
                a.show(a.simple().content(i("triTranslate")("Email canceled")).position("bottom right").hideDelay(3e3))
            }
            ...
            n.show({
                ...
                templateUrl: "app/examples/email/email-dialog.tmpl.html",
                targetEvent: t,
                locals: {title: o, email: l, contacts: s, getFocus: !0},
                focusOnOpen: !1
            }).then(function (t) {
                e.$emit("sendEmail", t)
            }, r)
        ...
        var u = this;
        u.closeEmail = r, u.deleteEmail = d, u.email = o, u.emailAction = m
    }
    ...
    function e(e, t, n, a, i, l, o, s, r) {
        ...
        var p = s.data, g = this;
        g.cancel = d, g.email = o, g.title = l, g.send = c, g.showCCSIcon = "zmdi zmdi-account-add", g.showCCS = !1, g.toggleCCS = m, g.triSkin = a.getCurrent(), g.queryContacts = u, r && e(function () {
            var e = i.retrieveEditor("emailBody").scope;
    ...
    function e(e, t, n, a, i, l, o) {
        function s() {
            h.event.backgroundColor = h.selectedColor.backgroundColor, h.event.borderColor = h.selectedColor.backgroundColor, h.event.textColor = h.selectedColor.textColor, h.event.palette = h.selectedColor.palette
        }

        function r() {
            h.event.start = p(h.start, h.startTime), null !== h.event.end && (h.event.end = p(h.end, h.endTime)), t.hide(h.event)
        }
        ...
        function m() {
            h.event.deleteMe = !0, t.hide(h.event)
        }

        function c() {
            h.event.allDay === !1 && null === h.event.end && (h.event.end = moment(h.event.start), h.event.end.endOf("day"), h.end = h.event.end.toDate(), h.endTime = u(h.event.end))
        }
        ...
        function g() {
            h.dateSelectOptions = {hours: [], minutes: []};
            for (var e = 0; e <= 23; e++)h.dateSelectOptions.hours.push(e);
            for (var t = 0; t <= 59; t++)h.dateSelectOptions.minutes.push(t)
        }

        var h = this;
        h.cancelClick = d, h.colors = [], h.colorChanged = s, h.deleteClick = m, h.allDayChanged = c, h.dialogData = i, h.edit = o, h.event = l, h.okClick = r, h.selectedColor = null, h.start = l.start.toDate(), h.startTime = u(l.start), null !== l.end && (h.end = l.end.toDate(), h.endTime = u(l.end)), g(), angular.forEach(a.palettes, function (e, t) {
            var n = {
                name: t.replace(/-/g, " "),
                palette: t,
            ...
            h.colors.push(n), t === h.event.palette && (h.selectedColor = n, h.colorChanged())
        })
    }
    ...
    function e(e, t, n, a, i, l, o, s, r) {
        function d(e, t) {
            var l = moment(p.currentDay).add(1, "h");
            n.show({
                ...
                locals: {
                    ...
                    event: {
                        title: i("triTranslate")("New Event"),
                        allDay: !1,
                        start: p.currentDay,
                        end: l,
                        palette: "cyan",
                ...
                p.eventSources[0].events.push(e), a.show(a.simple().content(i("triTranslate")("Event Created")).position("bottom right").hideDelay(2e3))
            })
        }

        function m(e, t, n) {
            for (var a = ["Pick up the kids", "Remember the milk", "Meeting with Morris", "Car service", "Go Surfing", "Party at Christos house", "Beer Oclock", "Festival tickets", "Laundry!", "Haircut appointment", "Walk the dog", "Dentist :(", "Board meeting", "Go fishing"], i = ["London", "New York", "Paris", "Burnley"], l = 0; l < e; l++) {
                var s = c(t, n), r = moment(s).add(1, "h"), d = Math.floor(Math.random() * (a.length - 0)), m = Math.floor(Math.random() * (i.length - 0)), g = u(o.palettes);
                p.eventSources[0].events.push({
                    ...
                    location: i[m],
                    backgroundColor: o.rgba(o.palettes[g][500].value),
                    borderColor: o.rgba(o.palettes[g][500].value),
                    textColor: o.rgba(o.palettes[g][500].contrast),
                    palette: g
                })
            }
        }
        ...
        function c(e, t) {
            var n = e.toDate().getTime(), a = t.toDate().getTime(), i = Math.random() * (a - n) + n;
            return moment(i)
        }
        ...
        p.addEvent = d, p.calendarOptions = {
            ...
            viewRender: function (e) {
                p.currentDay = e.calendar.getDate(), p.currentView = e.name, t.$broadcast("calendar-changeday", p.currentDay), s.layout.contentClass = "calendar-background-image background-overlay-static overlay-gradient-10 calendar-background-month-" + p.currentDay.month()
            },
            dayClick: function (e, t, n) {
                p.currentDay = e
            },
            eventClick: function (e, t, l) {
                n.show({
                    controller: "EventDialogController",
                    controllerAs: "vm",
                    templateUrl: "app/examples/calendar/event-dialog.tmpl.html",
                    ...
                    var t = "Event Updated";
                    angular.isDefined(e.deleteMe) && e.deleteMe === !0 ? (r.calendars["triangular-calendar"].fullCalendar("removeEvents", e._id), t = "Event Deleted") : r.calendars["triangular-calendar"].fullCalendar("updateEvent", e), a.show(a.simple().content(i("triTranslate")(t)).position("bottom right").hideDelay(2e3))
                })
            }
        }, p.viewFormats = {
            month: "MMMM YYYY",
    ...
    function e(e, t, n) {
        ...
        var i = [];
        for (var l in a)i.push(a[l].key), n.addLanguage({name: a[l].name, key: a[l].key});
        e.registerAvailableLanguageKeys(i, {en_US: "en", en_UK: "en"}).use("en"), e.useLocalStorage()
    }
    ...
    function e() {
        ...
        var l = {languages: [], name: "", logo: "", copyright: "", version: ""};
        this.addLanguage = e, this.setLogo = t, this.setName = n, this.setCopyright = a, this.setVersion = i, this.$get = function () {
            return {
    ...
    function e(e, t, n) {
        ...
        function l(t) {
            var a = e.defer(), i = !1;
            return angular.forEach(s.roles, function (e) {
                if (n.hasRoleDefinition(e)) {
                    var a = n.getStore();
                    angular.isDefined(a[e]) && -1 !== a[e].validationFunction.indexOf(t) && (i = !0)
                }
            }), i ? a.resolve() : a.reject(), a.promise
        }
        ...
        var s = {
            ...
            avatar: "assets/images/avatars/avatar-5.png",
            roles: ["SUPERADMIN"]
        }, r = {getCurrentUser: a, getUsers: i, hasPermission: l, login: o};
        return r
    }
    ...
    function e(e, t, n, a, i, l) {
        ...
        var s = t.get("tri-user");
        angular.isDefined(s) && l.login(s);
        var r = ["viewEmail", "viewGitHub", "viewCalendar", "viewLayouts", "viewTodo", "viewElements", "viewAuthentication", "viewCharts", "viewMaps"];
        a.defineManyPermissions(r, function (e) {
            return l.hasPermission(e)
        }), i.defineManyRoles({
        ...
        var d = e.$on("$stateChangePermissionDenied", o);
        e.$on("$destroy", function () {
            d()
        })
    }
    ...
    function e(e, t) {
        e.state("triangular.permission", {
            ...
            children: [{
                ...
                state: "triangular.permission-define",
                type: "link"
            }, {name: "Routes", state: "triangular.permission-routes", type: "link"}, {
                name: "Views",
                state: "triangular.permission-views",
                type: "link"
            }]
    ...
    function e(e, t) {
        var n = new Date;
        e.setName("triangular"), e.setCopyright("&copy;" + n.getFullYear() + " oxygenna.com"), e.setLogo("assets/images/logo.png"), e.setVersion("2.10.1"), t.setTitle("Triangular"), t.setSeparator("|")
    }
    ...
    function e(e, t) {
        ...
        }), t.when("", "/dashboards/analytics"), t.when("/", "/dashboards/analytics"), t.otherwise("/404")
    }
